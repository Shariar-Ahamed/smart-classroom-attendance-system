...
export default function Sidebar({ view, setView, isOpen = false, onClose }) {
  ...
  return (
    <>
      ...
      <aside
        className={`fixed inset-y-0 left-0 w-64 bg-slate-950/95 backdrop-blur-xl border-r border-slate-800/80 flex flex-col h-screen z-50 transition-transform duration-300 ease-in-out lg:sticky lg:top-0 lg:translate-x-0 ${
      ...
      >
        ...
        <div className="p-4 border-t border-slate-900">
          ...
          <button
            onClick={logout}
            className="w-full text-sm text-slate-400 hover:text-red-400 px-4 py-2.5 rounded-xl hover:bg-red-500/10 transition duration-300 flex items-center gap-2 font-semibold cursor-pointer"
          >
